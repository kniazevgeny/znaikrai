<template lang="pug">
	v-layout(column)
		v-card(style="margin-top: -65px; box-shadow: 0px 90px 90px 0px rgba(0,0,0,0.75); z-index: 1; position: initial" :dark='$store.state.dark')
		...
		Gmaps(id="map" style="z-index: 0; position: fixed;")
</template>
